...
//Step One: Prompt user's fave snack

let faveSnack = prompt("Please enter your favorite snack: ");
let numOfSnacksPerDay = prompt("How many " + faveSnack + " can you eat in a day?");
let userAge = prompt("Please enter your age: ");
let snacksUntil100InDays = 365 * (100 - userAge);
let snacksTotal = snacksUntil100InDays * numOfSnacksPerDay;

document.write("Congratulations, you have won a lifetime supply of " + faveSnack + 
"! <br> You will receive " + numOfSnacksPerDay + "\xa0" + faveSnack + " per day, for a grand total of " + snacksTotal +"\xa0" + faveSnack);
